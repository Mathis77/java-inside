...
class ExampleTests {
	...
	void callMethodHandlesLookupAStaticHello() throws Throwable {
		...
		var methodHandle = lookup.findStatic(Example.class, "aStaticHello",
	...
	void callMethodHandlesLookupAnInstanceHello() throws Throwable {
		var lookup = MethodHandles.privateLookupIn(Example.class, MethodHandles.lookup());
		var methodHandle = lookup.findVirtual(Example.class, "anInstanceHello",
				MethodType.methodType(String.class, int.class));
	...
	void guardWithTest() throws Throwable {
		...
		var testMethodHandle = testLookup
	...
	@Test
	void stringSwitchTest() throws Throwable {
		var mh = InliningCache.stringSwitch("foo", "bar", "com", "bazz", "hoho");
		assertEquals(0, (int) mh.invokeExact("foo"));
		assertEquals(1, (int) mh.invokeExact("bar"));
		assertEquals(2, (int) mh.invokeExact("com"));
		assertEquals(-1, (int) mh.invokeExact("booze"));
		assertEquals(4, (int) mh.invokeExact("hoho"));
	}

	@Test
	void stringSwitch2Test() throws Throwable {
		var mh = InliningCache.stringSwitch2("foo", "bar", "com", "bazz", "hoho");
		assertEquals(0, (int) mh.invokeExact("foo"));
		assertEquals(1, (int) mh.invokeExact("bar"));
		assertEquals(2, (int) mh.invokeExact("com"));
		assertEquals(-1, (int) mh.invokeExact("booze"));
